...
ifeq (${HUMAN_VERSION},)
	...
	HUMAN_VERSION=v2.19.0-dev-g$(shell git rev-parse --short HEAD)
	else
	HUMAN_VERSION=$(or $(shell git describe --tags --match "v[0-9]*"),v2.19.0-dev-g$(shell git rev-parse --short HEAD))
	endif
endif
