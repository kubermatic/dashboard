...
// WithAssumeRoleARN adds the assumeRoleARN to the list e k s clusters params
func (o *ListEKSClustersParams) WithAssumeRoleARN(assumeRoleARN *string) *ListEKSClustersParams {
	o.SetAssumeRoleARN(assumeRoleARN)
	return o
}

// SetAssumeRoleARN adds the assumeRoleARN to the list e k s clusters params
func (o *ListEKSClustersParams) SetAssumeRoleARN(assumeRoleARN *string) {
	o.AssumeRoleARN = assumeRoleARN
}

// WithAssumeRoleExternalID adds the assumeRoleExternalID to the list e k s clusters params
func (o *ListEKSClustersParams) WithAssumeRoleExternalID(assumeRoleExternalID *string) *ListEKSClustersParams {
	o.SetAssumeRoleExternalID(assumeRoleExternalID)
	return o
}

// SetAssumeRoleExternalID adds the assumeRoleExternalId to the list e k s clusters params
func (o *ListEKSClustersParams) SetAssumeRoleExternalID(assumeRoleExternalID *string) {
