...
// IsSuccess returns true when this list azure sizes o k response has a 2xx status code
func (o *ListAzureSizesOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this list azure sizes o k response has a 3xx status code
func (o *ListAzureSizesOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this list azure sizes o k response has a 4xx status code
func (o *ListAzureSizesOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this list azure sizes o k response has a 5xx status code
func (o *ListAzureSizesOK) IsServerError() bool {
	return false
}

// IsCode returns true when this list azure sizes o k response a status code equal to that given
func (o *ListAzureSizesOK) IsCode(code int) bool {
	return code == 200
}
...
func (o *ListAzureSizesOK) String() string {
	return fmt.Sprintf("[GET /api/v1/providers/azure/sizes][%d] listAzureSizesOK  %+v", 200, o.Payload)
}
...
// IsSuccess returns true when this list azure sizes default response has a 2xx status code
func (o *ListAzureSizesDefault) IsSuccess() bool {
	return o._statusCode/100 == 2
}

// IsRedirect returns true when this list azure sizes default response has a 3xx status code
func (o *ListAzureSizesDefault) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this list azure sizes default response has a 4xx status code
func (o *ListAzureSizesDefault) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this list azure sizes default response has a 5xx status code
func (o *ListAzureSizesDefault) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this list azure sizes default response a status code equal to that given
func (o *ListAzureSizesDefault) IsCode(code int) bool {
...
func (o *ListAzureSizesDefault) String() string {
	return fmt.Sprintf("[GET /api/v1/providers/azure/sizes][%d] listAzureSizes default  %+v", o._statusCode, o.Payload)
}
