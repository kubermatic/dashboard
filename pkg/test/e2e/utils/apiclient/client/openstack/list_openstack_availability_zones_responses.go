...
// IsSuccess returns true when this list openstack availability zones o k response has a 2xx status code
func (o *ListOpenstackAvailabilityZonesOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this list openstack availability zones o k response has a 3xx status code
func (o *ListOpenstackAvailabilityZonesOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this list openstack availability zones o k response has a 4xx status code
func (o *ListOpenstackAvailabilityZonesOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this list openstack availability zones o k response has a 5xx status code
func (o *ListOpenstackAvailabilityZonesOK) IsServerError() bool {
	return false
}

// IsCode returns true when this list openstack availability zones o k response a status code equal to that given
func (o *ListOpenstackAvailabilityZonesOK) IsCode(code int) bool {
	return code == 200
}
...
// IsRedirect returns true when this list openstack availability zones default response has a 3xx status code
func (o *ListOpenstackAvailabilityZonesDefault) IsRedirect() bool {
	return o._statusCode/100 == 3
}

// IsClientError returns true when this list openstack availability zones default response has a 4xx status code
func (o *ListOpenstackAvailabilityZonesDefault) IsClientError() bool {
	return o._statusCode/100 == 4
}

// IsServerError returns true when this list openstack availability zones default response has a 5xx status code
func (o *ListOpenstackAvailabilityZonesDefault) IsServerError() bool {
	return o._statusCode/100 == 5
}

// IsCode returns true when this list openstack availability zones default response a status code equal to that given
func (o *ListOpenstackAvailabilityZonesDefault) IsCode(code int) bool {
