...
// WithAssumeRoleARN adds the assumeRoleARN to the list project e k s security groups params
func (o *ListProjectEKSSecurityGroupsParams) WithAssumeRoleARN(assumeRoleARN *string) *ListProjectEKSSecurityGroupsParams {
	o.SetAssumeRoleARN(assumeRoleARN)
	return o
}

// SetAssumeRoleARN adds the assumeRoleARN to the list project e k s security groups params
func (o *ListProjectEKSSecurityGroupsParams) SetAssumeRoleARN(assumeRoleARN *string) {
	o.AssumeRoleARN = assumeRoleARN
}

// WithAssumeRoleExternalID adds the assumeRoleExternalID to the list project e k s security groups params
func (o *ListProjectEKSSecurityGroupsParams) WithAssumeRoleExternalID(assumeRoleExternalID *string) *ListProjectEKSSecurityGroupsParams {
	o.SetAssumeRoleExternalID(assumeRoleExternalID)
	return o
}

// SetAssumeRoleExternalID adds the assumeRoleExternalId to the list project e k s security groups params
func (o *ListProjectEKSSecurityGroupsParams) SetAssumeRoleExternalID(assumeRoleExternalID *string) {
