...
// WithAssumeRoleARN adds the assumeRoleARN to the list e k s subnets params
func (o *ListEKSSubnetsParams) WithAssumeRoleARN(assumeRoleARN *string) *ListEKSSubnetsParams {
	o.SetAssumeRoleARN(assumeRoleARN)
	return o
}

// SetAssumeRoleARN adds the assumeRoleARN to the list e k s subnets params
func (o *ListEKSSubnetsParams) SetAssumeRoleARN(assumeRoleARN *string) {
	o.AssumeRoleARN = assumeRoleARN
}

// WithAssumeRoleExternalID adds the assumeRoleExternalID to the list e k s subnets params
func (o *ListEKSSubnetsParams) WithAssumeRoleExternalID(assumeRoleExternalID *string) *ListEKSSubnetsParams {
	o.SetAssumeRoleExternalID(assumeRoleExternalID)
	return o
}

// SetAssumeRoleExternalID adds the assumeRoleExternalId to the list e k s subnets params
func (o *ListEKSSubnetsParams) SetAssumeRoleExternalID(assumeRoleExternalID *string) {
