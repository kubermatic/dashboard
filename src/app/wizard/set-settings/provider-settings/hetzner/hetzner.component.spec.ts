...
describe('HetznerClusterSettingsComponent', () => {
  ...
  it('token field validity', () => {
    ...
    expect(component.hetznerSettingsForm.controls.token.hasError('required'))
    ...
    expect(component.hetznerSettingsForm.controls.token.hasError('minlength'))
        .toBeTruthy('token field has min length error after setting foo');

    component.hetznerSettingsForm.controls.token.patchValue(
    ...
    expect(component.hetznerSettingsForm.controls.token.hasError('maxlength'))
