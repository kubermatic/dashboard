...
describe('OpenstackClusterSettingsComponent', () => {
  ...
  describe('Default config', () => {
    ...
    it('should set correct tenant placeholder', () => {
      ...
      fixture.detectChanges();
      expect(component.getTenantsFormState()).toEqual('Tenant/Project: Please enter your credentials first!');
      ...
      fixture.detectChanges();
      expect(component.getTenantsFormState()).toEqual('Loading Tenants/Projects...');

      component.loadingOptionalTenants = false;
      component.tenants = [];
      fixture.detectChanges();
      expect(component.getTenantsFormState()).toEqual('No Tenants/Projects available');

      component.tenants = openstackTenantsFake();
      fixture.detectChanges();
      expect(component.getTenantsFormState()).toEqual('Tenant/Project*:');
    });
    ...
    it('should set correct optional settings placeholder', () => {
      ...
      expect(component.getOptionalSettingsFormState('Security Group'))
          .toEqual('Security Group: Please enter Tenant/Project first!');
