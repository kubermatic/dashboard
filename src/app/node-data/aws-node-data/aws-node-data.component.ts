...
export class AWSNodeDataComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.form = new FormGroup({
      size: new FormControl({value: this.nodeData.spec.cloud.aws.instanceType, disabled: true}, [
        Validators.required,
      ...
      subnetID: new FormControl(this.nodeData.spec.cloud.aws.subnetID, [
        Validators.required,
        AutocompleteFilterValidators.mustBeInObjectList(this._subnetMap, 'id', true),
      ]),
    });
