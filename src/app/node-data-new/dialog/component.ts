...
import {getEmptyNodeProviderSpec} from '../../shared/entity/NodeEntity';
...
export interface DialogDataInput {
  ...
  initialClusterData?: ClusterEntity;
...
export class NodeDataDialogComponent extends BaseFormValidator implements OnInit, OnDestroy {
  ...
  private _isRecreationWarningVisible(): boolean {
    return (
      this.mode === Mode.Edit && !_.isEqual(objectDiff(this._data.initialNodeData, this._nodeDataService.nodeData), {})
    );
  }
}
