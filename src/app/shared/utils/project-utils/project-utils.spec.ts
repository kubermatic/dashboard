import {
  fakeInactiveProject,
  fakeProject,
} from '../../../testing/fake-data/project.fake';
...
describe('ProjectUtils', () => {
  it('should get state of icon', () => {
    expect(ProjectUtils.getStateIconClass('Active')).toBe(
      HealthStatusColor.Green
    );
    expect(ProjectUtils.getStateIconClass('Inactive')).toBe(
      HealthStatusColor.Red
    );
    expect(ProjectUtils.getStateIconClass('Terminating')).toBe(
