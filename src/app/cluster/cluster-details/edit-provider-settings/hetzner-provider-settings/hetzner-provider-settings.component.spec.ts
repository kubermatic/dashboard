...
describe('HetznerProviderSettingsComponent', () => {
  ...
  it('token field validity', () => {
    ...
    expect(component.hetznerProviderSettingsForm.controls.token.hasError('required'))
    ...
    expect(component.hetznerProviderSettingsForm.controls.token.hasError('minlength'))
        .toBeTruthy('token field has min length error after setting foo');

    component.hetznerProviderSettingsForm.controls.token.patchValue(
    ...
    expect(component.hetznerProviderSettingsForm.controls.token.hasError('maxlength'))
