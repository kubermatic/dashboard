...
export class AWSService {
  ...
  getSubnets(projectID: string, clusterID: string): Observable<AWSSubnet[]> {
    const url = `${this._newRestRoot}/projects/${projectID}/clusters/${clusterID}/providers/aws/subnets`;
    return this._httpClient.get<AWSSubnet[]>(url);
  }

  getSizes(projectID: string, clusterID: string): Observable<AWSSize[]> {
    const url = `${this._newRestRoot}/projects/${projectID}/clusters/${clusterID}/providers/aws/sizes`;
    return this._httpClient.get<AWSSize[]>(url);
  }
}
