...
time find $API/pkg/test/e2e/utils/apiclient/ -type f -exec sed "$sed_expression" -i {} \;

# sync the files
echo "Synchronizing the files"
rsync --archive --verbose --delete "./$API/pkg/test/e2e/utils/apiclient/client/" "$tempdir/client/"
rsync --archive --verbose --delete "./$API/pkg/test/e2e/utils/apiclient/models/" "$tempdir/models/"
