...
run_swagger generate spec --tags=ee --scan-models -o ${TMP_SWAGGER} -x k8c.io/kubermatic/* -x github.com/sigstore/rekor/pkg/generated/models -x k8s.io/api/admissionregistration/*
