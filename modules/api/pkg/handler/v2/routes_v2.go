...
import (
	...
	"k8c.io/dashboard/v2/pkg/handler/v2/alertmanager"
	...
	"k8c.io/dashboard/v2/pkg/handler/v2/etcdrestore"
	externalcluster "k8c.io/dashboard/v2/pkg/handler/v2/external_cluster"
	featuregates "k8c.io/dashboard/v2/pkg/handler/v2/feature_gates"
	...
	operatingsystemprofile "k8c.io/dashboard/v2/pkg/handler/v2/operatingsystemprofile"
	"k8c.io/dashboard/v2/pkg/handler/v2/preset"
	"k8c.io/dashboard/v2/pkg/handler/v2/provider"
...
func (r Routing) RegisterV2(mux *mux.Router, oidcKubeConfEndpoint bool) {
	...
	mux.Methods(http.MethodGet).
		Path("/projects/{project_id}/providers/vsphere/tagcategories/{tag_category}/tags").
		Handler(r.listProjectVSphereTagsForTagCategories())
	...
	mux.Methods(http.MethodGet).
		Path("/projects/{project_id}/clusters/{cluster_id}/providers/vsphere/tagcategories/{tag_category}/tags").
	...
	mux.Methods(http.MethodGet).
		Path("/projects/{project_id}/clusterbackupstoragelocation/{cbsl_name}").
		Handler(r.getCBSL())
	...
	mux.Methods(http.MethodGet).
		...
		Handler(r.listKyvernoPolicyTemplates())
	...
	mux.Methods(http.MethodGet).
		Path("/policytemplates/{template_name}").
...
func (r Routing) patchCluster() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.SetClusterProvider(r.clusterProviderGetter, r.seedsGetter),
			middleware.SetPrivilegedClusterProvider(r.clusterProviderGetter, r.seedsGetter),
		)(cluster.PatchEndpoint(r.projectProvider, r.privilegedProjectProvider, r.seedsGetter, r.userInfoGetter, r.caBundle, r.kubermaticConfigGetter, r.features, r.settingsProvider)),
...
func (r Routing) createMachineDeployment() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.SetClusterProvider(r.clusterProviderGetter, r.seedsGetter),
			middleware.SetPrivilegedClusterProvider(r.clusterProviderGetter, r.seedsGetter),
		)(machine.CreateMachineDeployment(r.sshKeyProvider, r.projectProvider, r.privilegedProjectProvider, r.seedsGetter, r.userInfoGetter, r.settingsProvider)),
...
func (r Routing) patchMachineDeployment() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.SetClusterProvider(r.clusterProviderGetter, r.seedsGetter),
			middleware.SetPrivilegedClusterProvider(r.clusterProviderGetter, r.seedsGetter),
		)(machine.PatchMachineDeployment(r.sshKeyProvider, r.projectProvider, r.privilegedProjectProvider, r.seedsGetter, r.userInfoGetter, r.settingsProvider)),
...
// swagger:route GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/vsphere/tagcategories/{tag_category}/tags vsphere listVSphereTagsForTagCategoryNoCredentials
//
// Lists tags for a tag category from vSphere datacenter.
//
//	Produces:
//	- application/json
//
...
//	  default: errorResponse
//	  200: []VSphereTag
func (r Routing) listVSphereTagsForTagCategoryNoCredentials() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			middleware.TokenVerifier(r.tokenVerifiers, r.userProvider),
			middleware.UserSaver(r.userProvider),
			middleware.SetClusterProvider(r.clusterProviderGetter, r.seedsGetter),
			middleware.SetPrivilegedClusterProvider(r.clusterProviderGetter, r.seedsGetter),
		)(provider.VsphereTagsForTagCategoryWithClusterCredentialsEndpoint(r.projectProvider, r.privilegedProjectProvider, r.seedsGetter, r.userInfoGetter, r.caBundle)),
		provider.DecodeVSphereTagsNoCredentialsReq,
		handler.EncodeJSON,
		r.defaultServerOptions()...,
	)
}
...
func (r Routing) listProjectKubevirtStorageClasses() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			middleware.TokenVerifier(r.tokenVerifiers, r.userProvider),
			middleware.UserSaver(r.userProvider),
		)(provider.KubeVirtStorageClassesEndpoint(r.presetProvider, r.userInfoGetter, r.seedsGetter, true)),
		provider.DecodeKubeVirtProjectGenericReq,
		handler.EncodeJSON,
		r.defaultServerOptions()...,
	)
...
// swagger:route GET /api/v2/projects/{project_id}/providers/vsphere/tagcategories/{tag_category}/tags vsphere listProjectVSphereTagsForTagCategories
//
// Lists tags for a tag category from vSphere datacenter.
//
//	Produces:
...
//	  default: errorResponse
//	  200: []VSphereTag
func (r Routing) listProjectVSphereTagsForTagCategories() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			middleware.TokenVerifier(r.tokenVerifiers, r.userProvider),
			middleware.UserSaver(r.userProvider),
		)(provider.VsphereTagForTagCategoryEndpoint(r.seedsGetter, r.presetProvider, r.userInfoGetter, r.caBundle)),
		provider.DecodeVSphereTagsReq,
		handler.EncodeJSON,
		r.defaultServerOptions()...,
	)
}
...
func (r Routing) createClusterTemplate() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.UserSaver(r.userProvider),
			middleware.SetPrivilegedClusterProvider(r.clusterProviderGetter, r.seedsGetter),
		)(clustertemplate.CreateEndpoint(r.projectProvider, r.privilegedProjectProvider, r.userInfoGetter, r.clusterTemplateProvider, r.seedsGetter, r.presetProvider, r.caBundle, r.exposeStrategy, r.sshKeyProvider, r.kubermaticConfigGetter, r.features, r.settingsProvider)),
...
func (r Routing) importClusterTemplate() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.UserSaver(r.userProvider),
			middleware.SetPrivilegedClusterProvider(r.clusterProviderGetter, r.seedsGetter),
		)(clustertemplate.ImportEndpoint(r.projectProvider, r.privilegedProjectProvider, r.userInfoGetter, r.clusterTemplateProvider, r.seedsGetter, r.presetProvider, r.caBundle, r.exposeStrategy, r.sshKeyProvider, r.kubermaticConfigGetter, r.features, r.settingsProvider)),
...
func (r Routing) updateClusterTemplate() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.UserSaver(r.userProvider),
			middleware.SetPrivilegedClusterProvider(r.clusterProviderGetter, r.seedsGetter),
		)(clustertemplate.UpdateEndpoint(r.projectProvider, r.privilegedProjectProvider, r.userInfoGetter, r.clusterTemplateProvider, r.seedsGetter, r.presetProvider, r.caBundle, r.exposeStrategy, r.sshKeyProvider, r.kubermaticConfigGetter, r.features, r.settingsProvider)),
...
func (r Routing) createClusterBackup() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.SetClusterProvider(r.clusterProviderGetter, r.seedsGetter),
			middleware.SetPrivilegedClusterProvider(r.clusterProviderGetter, r.seedsGetter),
		)(clusterbackup.CreateEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
func (r Routing) listClusterBackup() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.SetClusterProvider(r.clusterProviderGetter, r.seedsGetter),
			middleware.SetPrivilegedClusterProvider(r.clusterProviderGetter, r.seedsGetter),
		)(clusterbackup.ListEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
func (r Routing) getClusterBackup() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.SetClusterProvider(r.clusterProviderGetter, r.seedsGetter),
			middleware.SetPrivilegedClusterProvider(r.clusterProviderGetter, r.seedsGetter),
		)(clusterbackup.GetEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
func (r Routing) createClusterRestore() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.UserSaver(r.userProvider),
			middleware.SetClusterProvider(r.clusterProviderGetter, r.seedsGetter),
			middleware.SetPrivilegedClusterProvider(r.clusterProviderGetter, r.seedsGetter))(clusterrestore.CreateEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
func (r Routing) listClusterRestore() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(middleware.TokenVerifier(r.tokenVerifiers, r.userProvider),
			middleware.UserSaver(r.userProvider),
			middleware.SetClusterProvider(r.clusterProviderGetter, r.seedsGetter),
			middleware.SetPrivilegedClusterProvider(r.clusterProviderGetter, r.seedsGetter))(clusterrestore.ListEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
func (r Routing) getClusterRestore() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.UserSaver(r.userProvider),
			middleware.SetClusterProvider(r.clusterProviderGetter, r.seedsGetter),
			middleware.SetPrivilegedClusterProvider(r.clusterProviderGetter, r.seedsGetter))(clusterrestore.GetEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
func (r Routing) deleteClusterRestore() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.UserSaver(r.userProvider),
			middleware.SetClusterProvider(r.clusterProviderGetter, r.seedsGetter),
			middleware.SetPrivilegedClusterProvider(r.clusterProviderGetter, r.seedsGetter))(clusterrestore.DeleteEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
func (r Routing) createClusterBackupSchedule() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.UserSaver(r.userProvider),
			middleware.SetClusterProvider(r.clusterProviderGetter, r.seedsGetter),
			middleware.SetPrivilegedClusterProvider(r.clusterProviderGetter, r.seedsGetter))(clusterbackupschedule.CreateEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
func (r Routing) listClusterBackupSchedule() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(middleware.TokenVerifier(r.tokenVerifiers, r.userProvider),
			middleware.UserSaver(r.userProvider),
			middleware.SetClusterProvider(r.clusterProviderGetter, r.seedsGetter),
			middleware.SetPrivilegedClusterProvider(r.clusterProviderGetter, r.seedsGetter))(clusterbackupschedule.ListEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
func (r Routing) getClusterBackupSchedule() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.UserSaver(r.userProvider),
			middleware.SetClusterProvider(r.clusterProviderGetter, r.seedsGetter),
			middleware.SetPrivilegedClusterProvider(r.clusterProviderGetter, r.seedsGetter))(clusterbackupschedule.GetEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
// swagger:route GET /api/v2/projects/{project_id}/clusterbackupstoragelocation/{cbsl_name} project getClusterBackupStorageLocation
//
...
// swagger:route GET /api/v2/projects/{project_id}/clusterbackupstoragelocation/{cbsl_name}/bucketobjects project listClusterBackupStorageLocationBucketObjects
//
//	List objects from bucket of a cluster backup storage location for a given project based on its name
//
//	Produces:
//	- application/json
//
//	Responses:
//	  default: errorResponse
//	  200: BackupStorageLocationBucketObjectList
//	  401: empty
//	  403: empty
func (r Routing) listCBSLBucketObjects() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			middleware.TokenVerifier(r.tokenVerifiers, r.userProvider),
			middleware.UserSaver(r.userProvider),
...
// swagger:route DELETE /api/v2/projects/{project_id}/clusterbackupstoragelocation/{cbsl_name} project deleteClusterBackupStorageLocation
//
...
// swagger:route PATCH /api/v2/projects/{project_id}/clusterbackupstoragelocation/{cbsl_name} project patchClusterBackupStorageLocation
//
...
func (r Routing) createEtcdBackupConfig() http.Handler {
	return httptransport.NewServer(
		...
		)(etcdbackupconfig.CreateEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
func (r Routing) getEtcdBackupConfig() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.EtcdBackupConfig(r.clusterProviderGetter, r.etcdBackupConfigProviderGetter, r.seedsGetter),
			middleware.PrivilegedEtcdBackupConfig(r.clusterProviderGetter, r.etcdBackupConfigProviderGetter, r.seedsGetter),
		)(etcdbackupconfig.GetEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
func (r Routing) listEtcdBackupConfig() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.EtcdBackupConfig(r.clusterProviderGetter, r.etcdBackupConfigProviderGetter, r.seedsGetter),
			middleware.PrivilegedEtcdBackupConfig(r.clusterProviderGetter, r.etcdBackupConfigProviderGetter, r.seedsGetter),
		)(etcdbackupconfig.ListEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
func (r Routing) deleteEtcdBackupConfig() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.EtcdBackupConfig(r.clusterProviderGetter, r.etcdBackupConfigProviderGetter, r.seedsGetter),
			middleware.PrivilegedEtcdBackupConfig(r.clusterProviderGetter, r.etcdBackupConfigProviderGetter, r.seedsGetter),
		)(etcdbackupconfig.DeleteEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
		etcdbackupconfig.DecodeGetEtcdBackupConfigReq,
		handler.EncodeJSON,
		r.defaultServerOptions()...,
	)
...
func (r Routing) patchEtcdBackupConfig() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.EtcdBackupConfig(r.clusterProviderGetter, r.etcdBackupConfigProviderGetter, r.seedsGetter),
			middleware.PrivilegedEtcdBackupConfig(r.clusterProviderGetter, r.etcdBackupConfigProviderGetter, r.seedsGetter),
		)(etcdbackupconfig.PatchEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
func (r Routing) listProjectEtcdBackupConfig() http.Handler {
	return httptransport.NewServer(
		...
		)(etcdbackupconfig.ProjectListEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
func (r Routing) createEtcdRestore() http.Handler {
	return httptransport.NewServer(
		...
		)(etcdrestore.CreateEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
func (r Routing) getEtcdRestore() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.EtcdRestore(r.clusterProviderGetter, r.etcdRestoreProviderGetter, r.seedsGetter),
			middleware.PrivilegedEtcdRestore(r.clusterProviderGetter, r.etcdRestoreProviderGetter, r.seedsGetter),
		)(etcdrestore.GetEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
func (r Routing) listEtcdRestore() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.EtcdRestore(r.clusterProviderGetter, r.etcdRestoreProviderGetter, r.seedsGetter),
			middleware.PrivilegedEtcdRestore(r.clusterProviderGetter, r.etcdRestoreProviderGetter, r.seedsGetter),
		)(etcdrestore.ListEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
func (r Routing) deleteEtcdRestore() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			...
			middleware.EtcdRestore(r.clusterProviderGetter, r.etcdRestoreProviderGetter, r.seedsGetter),
			middleware.PrivilegedEtcdRestore(r.clusterProviderGetter, r.etcdRestoreProviderGetter, r.seedsGetter),
		)(etcdrestore.DeleteEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
		etcdrestore.DecodeGetEtcdRestoreReq,
		handler.EncodeJSON,
		r.defaultServerOptions()...,
	)
...
func (r Routing) listProjectEtcdRestore() http.Handler {
	return httptransport.NewServer(
		...
		)(etcdrestore.ProjectListEndpoint(r.userInfoGetter, r.projectProvider, r.privilegedProjectProvider, r.settingsProvider)),
...
func (r Routing) listKubevirtStorageClasses() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			middleware.TokenVerifier(r.tokenVerifiers, r.userProvider),
			middleware.UserSaver(r.userProvider),
		)(provider.KubeVirtStorageClassesEndpoint(r.presetProvider, r.userInfoGetter, r.seedsGetter, false)),
		provider.DecodeKubeVirtGenericReq,
		handler.EncodeJSON,
		r.defaultServerOptions()...,
	)
...
// swagger:route PUT /api/v2/applicationdefinitions/{appdef_name} applications updateApplicationDefinition
//
...
//	   401: empty
//	   403: empty
func (r Routing) updateApplicationDefinition() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			middleware.TokenVerifier(r.tokenVerifiers, r.userProvider),
			middleware.UserSaver(r.userProvider),
...
//	  401: empty
//	  403: empty
func (r Routing) listKyvernoPolicyTemplates() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			middleware.TokenVerifier(r.tokenVerifiers, r.userProvider),
			middleware.UserSaver(r.userProvider),
...
//
//	Get policy template, If the query parameter project_id is set, the endpoint will return the policy template if it is associated with the specified project_id. Only available in Kubermatic Enterprise Edition
//
//	Produces:
//	- application/json
//
...
// swagger:route POST /api/v2/policytemplates admin createPolicyTemplate
//
...
// swagger:route PATCH /api/v2/policytemplates/{template_name} admin patchpolicyTemplate
//
...
// swagger:route DELETE /api/v2/policytemplates/{template_name} admin deletePolicyTemplate
//
//	Delete policy template, If the query parameter project_id is set, the endpoint will delete the policy template if it is associated with the specified project_id. Only available in Kubermatic Enterprise Edition
//
//	Produces:
//	- application/json
//
...
// swagger:route GET /api/v2/projects/{project_id}/clusters/{cluster_id}/policybindings project listPolicyBinding
//
...
func (r Routing) listKyvernoPolicyBindings() http.Handler {
	return httptransport.NewServer(
		endpoint.Chain(
			middleware.TokenVerifier(r.tokenVerifiers, r.userProvider),
			middleware.UserSaver(r.userProvider),
...
// swagger:route GET /api/v2/projects/{project_id}/clusters/{cluster_id}/policybindings/{binding_name} project getPolicyBinding
//
...
// swagger:route POST /api/v2/projects/{project_id}/clusters/{cluster_id}/policybindings project createPolicyBinding
//
...
// swagger:route PATCH /api/v2/projects/{project_id}/clusters/{cluster_id}/policybindings/{binding_name} project patchPolicyBinding
//
