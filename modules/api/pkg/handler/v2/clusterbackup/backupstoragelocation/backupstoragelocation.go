...
func DecodeCreateBackupStorageLocationReq(c context.Context, r *http.Request) (interface{}, error) {
	return decodeCreateBackupStorageLocationReq(c, r)
}
...
func DecodeListBackupStorageLocationReq(c context.Context, r *http.Request) (interface{}, error) {
	return decodeListBackupStorageLocationReq(c, r)
}
...
func DecodeGetBackupStorageLocationReq(c context.Context, r *http.Request) (interface{}, error) {
	return decodeGetBackupStorageLocationReq(c, r)
}
...
func DecodeDeleteBackupStorageLocationReq(c context.Context, r *http.Request) (interface{}, error) {
	return decodeDeleteBackupStorageLocationReq(c, r)
}

func PatchEndpoint(userInfoGetter provider.UserInfoGetter, projectProvider provider.ProjectProvider,
	privilegedProjectProvider provider.PrivilegedProjectProvider, settingsProvider provider.SettingsProvider) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
		return patchEndpoint(ctx, request, userInfoGetter, projectProvider, privilegedProjectProvider, settingsProvider)
	}
}

func DecodePatchBackupStorageLocationReq(c context.Context, r *http.Request) (interface{}, error) {
	return decodePatchBackupStorageLocationReq(c, r)
}
