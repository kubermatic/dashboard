...
func DecodeGetPolicyInstanceReq(_ context.Context, _ *http.Request) (interface{}, error) {
	return nil, nil
}
...
func DecodeCreatePolicyInstanceReq(_ context.Context, _ *http.Request) (interface{}, error) {
	return nil, nil
}
...
func DecodePatchPolicyInstanceReq(_ context.Context, _ *http.Request) (interface{}, error) {
	return nil, nil
}

func deleteEndpoint(_ context.Context, _ interface{}, _ provider.UserInfoGetter) (interface{}, error) {
	return nil, nil
}
