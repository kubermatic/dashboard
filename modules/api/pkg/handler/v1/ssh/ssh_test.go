...
func TestCreateSSHKeysEndpoint(t *testing.T) {
	...
	testcases := []struct {
		...
		// scenario 1
		{
			...
			ExpectedResponse: `{"id":"%s","name":"my-second-ssh-key","creationTimestamp":"0001-01-01T00:00:00Z","spec":{"fingerprint":"","publicKey":"ssh-rsa  user@example.com "}}`,
