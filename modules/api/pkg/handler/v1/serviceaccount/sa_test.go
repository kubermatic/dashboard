...
import (
	...
	serviceaccount "k8c.io/dashboard/v2/pkg/provider/kubernetes"
	...
	for _, tc := range testcases {
		t.Run(tc.name, func(t *testing.T) {
			...
			if tc.httpStatus == http.StatusCreated {
				...
				err = client.FakeSeedClient.Get(context.Background(), ctrlruntimeclient.ObjectKey{Name: saName}, expectedSA)
				if err != nil {
