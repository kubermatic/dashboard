...
func ListAlibabaInstanceTypes(accessKeyID string, accessKeySecret string, region string, machineFilter kubermaticv1.MachineFlavorFilter) (apiv1.AlibabaInstanceTypeList, error) {
	...
	recommendedInstanceFamilies := sets.New("ecs.g6", "ecs.g5", "ecs.g5se", "ecs.g5ne", "ecs.ic5", "ecs.c6", "ecs.c5", "ecs.r6", "ecs.r5", "ecs.d1ne", "ecs.i2", "ecs.i2g", "ecs.hfc6", "ecs.hfg6", "ecs.hfr6")
	gpuInstanceFamilies := sets.New("ecs.gn3", "ecs.ga1", "ecs.gn4", "ecs.gn6i", "ecs.vgn6i", "ecs.gn6e", "ecs.gn6v", "ecs.vgn5i", "ecs.gn5", "ecs.gn5i")
	availableInstanceFamilies := sets.Set[string]{}
