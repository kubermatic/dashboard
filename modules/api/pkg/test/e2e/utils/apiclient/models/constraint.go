...
func (m *Constraint) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Constraint) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
