...
func (m *ExternalClusterNode) validateCreationTimestamp(formats strfmt.Registry) error {
...
func (m *ExternalClusterNode) validateDeletionTimestamp(formats strfmt.Registry) error {
...
func (m *ExternalClusterNode) validateSpec(formats strfmt.Registry) error {
...
func (m *ExternalClusterNode) validateStatus(formats strfmt.Registry) error {
...
func (m *ExternalClusterNode) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ExternalClusterNode) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
