...
func (m *ClusterTemplateInstance) validateSpec(formats strfmt.Registry) error {
...
func (m *ClusterTemplateInstance) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ClusterTemplateInstance) UnmarshalBinary(b []byte) error {
	var res ClusterTemplateInstance
