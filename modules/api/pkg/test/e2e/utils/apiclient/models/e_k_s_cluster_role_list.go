...
// Validate validates this e k s cluster role list
func (m EKSClusterRoleList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m EKSClusterRoleList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
