...
func (m *Datacenter) contextValidateMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *Datacenter) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
