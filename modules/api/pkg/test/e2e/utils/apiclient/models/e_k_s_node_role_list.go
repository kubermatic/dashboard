...
// Validate validates this e k s node role list
func (m EKSNodeRoleList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m EKSNodeRoleList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
