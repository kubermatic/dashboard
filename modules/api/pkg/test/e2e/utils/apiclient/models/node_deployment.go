...
func (m *NodeDeployment) contextValidateSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NodeDeployment) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
