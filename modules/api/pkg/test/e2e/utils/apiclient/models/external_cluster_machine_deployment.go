...
func (m *ExternalClusterMachineDeployment) validateCreationTimestamp(formats strfmt.Registry) error {
...
func (m *ExternalClusterMachineDeployment) validateDeletionTimestamp(formats strfmt.Registry) error {
...
func (m *ExternalClusterMachineDeployment) validateStatus(formats strfmt.Registry) error {
...
func (m *ExternalClusterMachineDeployment) UnmarshalBinary(b []byte) error {
	var res ExternalClusterMachineDeployment
