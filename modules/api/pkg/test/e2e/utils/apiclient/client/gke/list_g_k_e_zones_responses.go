...
func (o *ListGKEZonesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the list g k e zones o k response
func (o *ListGKEZonesOK) Code() int {
	return 200
}

func (o *ListGKEZonesOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/providers/gke/zones][%d] listGKEZonesOK %s", 200, payload)
}
...
func (o *ListGKEZonesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/providers/gke/zones][%d] listGKEZones default %s", o._statusCode, payload)
}
