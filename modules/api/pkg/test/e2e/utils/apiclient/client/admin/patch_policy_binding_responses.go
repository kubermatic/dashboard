...
func (o *PatchPolicyBindingOK) Error() string {
	return fmt.Sprintf("[PATCH /api/v2/policybindings/{binding_name}][%d] patchPolicyBindingOK  %+v", 200, o.Payload)
}
...
func (o *PatchPolicyBindingUnauthorized) Error() string {
	return fmt.Sprintf("[PATCH /api/v2/policybindings/{binding_name}][%d] patchPolicyBindingUnauthorized ", 401)
}
...
func (o *PatchPolicyBindingForbidden) Error() string {
	return fmt.Sprintf("[PATCH /api/v2/policybindings/{binding_name}][%d] patchPolicyBindingForbidden ", 403)
}
...
func (o *PatchPolicyBindingDefault) Error() string {
	return fmt.Sprintf("[PATCH /api/v2/policybindings/{binding_name}][%d] patchPolicyBinding default  %+v", o._statusCode, o.Payload)
}
