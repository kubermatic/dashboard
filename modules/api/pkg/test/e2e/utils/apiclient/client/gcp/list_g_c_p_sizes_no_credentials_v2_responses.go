...
func (o *ListGCPSizesNoCredentialsV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the list g c p sizes no credentials v2 o k response
func (o *ListGCPSizesNoCredentialsV2OK) Code() int {
	return 200
}

func (o *ListGCPSizesNoCredentialsV2OK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/gcp/sizes][%d] listGCPSizesNoCredentialsV2OK %s", 200, payload)
}
...
func (o *ListGCPSizesNoCredentialsV2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/gcp/sizes][%d] listGCPSizesNoCredentialsV2 default %s", o._statusCode, payload)
}
