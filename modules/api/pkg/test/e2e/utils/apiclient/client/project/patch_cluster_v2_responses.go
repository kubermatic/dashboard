...
func (o *PatchClusterV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the patch cluster v2 o k response
func (o *PatchClusterV2OK) Code() int {
	return 200
}

func (o *PatchClusterV2OK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /api/v2/projects/{project_id}/clusters/{cluster_id}][%d] patchClusterV2OK %s", 200, payload)
}
...
// Code gets the status code for the patch cluster v2 unauthorized response
func (o *PatchClusterV2Unauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the patch cluster v2 forbidden response
func (o *PatchClusterV2Forbidden) Code() int {
	return 403
}
...
func (o *PatchClusterV2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /api/v2/projects/{project_id}/clusters/{cluster_id}][%d] patchClusterV2 default %s", o._statusCode, payload)
}
