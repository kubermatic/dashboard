...
func (o *ListProjectVSphereDatastoresReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the list project v sphere datastores o k response
func (o *ListProjectVSphereDatastoresOK) Code() int {
	return 200
}

func (o *ListProjectVSphereDatastoresOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/providers/vsphere/datastores][%d] listProjectVSphereDatastoresOK %s", 200, payload)
}
...
func (o *ListProjectVSphereDatastoresDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/providers/vsphere/datastores][%d] listProjectVSphereDatastores default %s", o._statusCode, payload)
}
