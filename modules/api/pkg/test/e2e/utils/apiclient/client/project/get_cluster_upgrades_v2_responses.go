...
func (o *GetClusterUpgradesV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the get cluster upgrades v2 o k response
func (o *GetClusterUpgradesV2OK) Code() int {
	return 200
}

func (o *GetClusterUpgradesV2OK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/upgrades][%d] getClusterUpgradesV2OK %s", 200, payload)
}
...
// Code gets the status code for the get cluster upgrades v2 unauthorized response
func (o *GetClusterUpgradesV2Unauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the get cluster upgrades v2 forbidden response
func (o *GetClusterUpgradesV2Forbidden) Code() int {
	return 403
}
...
func (o *GetClusterUpgradesV2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/upgrades][%d] getClusterUpgradesV2 default %s", o._statusCode, payload)
}
