...
func (o *ListAzureAvailabilityZonesNoCredentialsV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the list azure availability zones no credentials v2 o k response
func (o *ListAzureAvailabilityZonesNoCredentialsV2OK) Code() int {
	return 200
}

func (o *ListAzureAvailabilityZonesNoCredentialsV2OK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/azure/availabilityzones][%d] listAzureAvailabilityZonesNoCredentialsV2OK %s", 200, payload)
}
...
func (o *ListAzureAvailabilityZonesNoCredentialsV2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/azure/availabilityzones][%d] listAzureAvailabilityZonesNoCredentialsV2 default %s", o._statusCode, payload)
}
