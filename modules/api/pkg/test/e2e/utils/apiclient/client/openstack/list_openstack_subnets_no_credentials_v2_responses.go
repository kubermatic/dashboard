...
func (o *ListOpenstackSubnetsNoCredentialsV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the list openstack subnets no credentials v2 o k response
func (o *ListOpenstackSubnetsNoCredentialsV2OK) Code() int {
	return 200
}

func (o *ListOpenstackSubnetsNoCredentialsV2OK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/openstack/subnets][%d] listOpenstackSubnetsNoCredentialsV2OK %s", 200, payload)
}
...
func (o *ListOpenstackSubnetsNoCredentialsV2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/openstack/subnets][%d] listOpenstackSubnetsNoCredentialsV2 default %s", o._statusCode, payload)
}
