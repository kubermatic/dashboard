...
func (o *ValidateEKSCredentialsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the validate e k s credentials o k response
func (o *ValidateEKSCredentialsOK) Code() int {
	return 200
}
...
func (o *ValidateEKSCredentialsDefault) Error() string {
	...
	return fmt.Sprintf("[GET /api/v2/providers/eks/validatecredentials][%d] validateEKSCredentials default %s", o._statusCode, payload)
}
