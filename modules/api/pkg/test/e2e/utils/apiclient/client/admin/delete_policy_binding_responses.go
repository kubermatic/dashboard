...
func (o *DeletePolicyBindingOK) Error() string {
	return fmt.Sprintf("[DELETE /api/v2/policybindings/{binding_name}/{namespace}][%d] deletePolicyBindingOK ", 200)
}
...
func (o *DeletePolicyBindingUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /api/v2/policybindings/{binding_name}/{namespace}][%d] deletePolicyBindingUnauthorized ", 401)
}
...
func (o *DeletePolicyBindingForbidden) Error() string {
	return fmt.Sprintf("[DELETE /api/v2/policybindings/{binding_name}/{namespace}][%d] deletePolicyBindingForbidden ", 403)
}
...
func (o *DeletePolicyBindingDefault) Error() string {
	return fmt.Sprintf("[DELETE /api/v2/policybindings/{binding_name}/{namespace}][%d] deletePolicyBinding default  %+v", o._statusCode, o.Payload)
}
