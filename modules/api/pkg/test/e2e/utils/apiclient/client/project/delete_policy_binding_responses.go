...
func (o *DeletePolicyBindingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DeletePolicyBindingDefault) Error() string {
	...
	return fmt.Sprintf("[DELETE /api/v2/projects/{project_id}/clusters/{cluster_id}/policybindings/{binding_name}][%d] deletePolicyBinding default %s", o._statusCode, payload)
}
