...
import (
	...
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/addon"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/admin"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/aks"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/alibaba"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/allowedregistries"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/allowedregistry"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/anexia"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/applications"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/aws"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/azure"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/backupcredentials"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/backupstoragelocation"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/cniversion"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/constraint"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/constraints"
	...
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/etcdrestore"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/gcp"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/get"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/gke"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/hetzner"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/ipampool"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/kubevirt"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/metering"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/metric"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/mlaadminsetting"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/networkdefaults"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/nutanix"
	...
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/rulegroup"
	...
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/user_cluster_config"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/users"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/version"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/versions"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/vmwareclouddirector"
	"k8c.io/dashboard/v2/pkg/test/e2e/utils/apiclient/client/vsphere"
)
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *KubermaticKubernetesPlatformAPI {
	...
	cli.UserClusterConfig = user_cluster_config.New(transport, formats)
...
type KubermaticKubernetesPlatformAPI struct {
	...
	UserClusterConfig user_cluster_config.ClientService
...
func (c *KubermaticKubernetesPlatformAPI) SetTransport(transport runtime.ClientTransport) {
	...
	c.UserClusterConfig.SetTransport(transport)
