...
func (o *ListGCPDiskTypesNoCredentialsV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the list g c p disk types no credentials v2 o k response
func (o *ListGCPDiskTypesNoCredentialsV2OK) Code() int {
	return 200
}

func (o *ListGCPDiskTypesNoCredentialsV2OK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/gcp/disktypes][%d] listGCPDiskTypesNoCredentialsV2OK %s", 200, payload)
}
...
func (o *ListGCPDiskTypesNoCredentialsV2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/gcp/disktypes][%d] listGCPDiskTypesNoCredentialsV2 default %s", o._statusCode, payload)
}
