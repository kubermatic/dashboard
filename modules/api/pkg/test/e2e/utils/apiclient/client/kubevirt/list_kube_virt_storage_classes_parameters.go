...
ListKubeVirtStorageClassesParams contains all the parameters to send to the API endpoint
	...
	for the list kube virt storage classes operation.
...
// WithDefaults hydrates default values in the list kube virt storage classes params (not the query body).
//
...
// SetDefaults hydrates default values in the list kube virt storage classes params (not the query body).
//
// All values with no default are reset to their zero value.
...
// SetKubeconfig adds the kubeconfig to the list kube virt storage classes params
