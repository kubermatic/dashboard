...
func (o *GetPolicyBindingReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetPolicyBindingOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/policybindings/{binding_name}][%d] getPolicyBindingOK %s", 200, payload)
}
...
func (o *GetPolicyBindingUnauthorized) Error() string {
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/policybindings/{binding_name}][%d] getPolicyBindingUnauthorized", 401)
}
...
func (o *GetPolicyBindingForbidden) Error() string {
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/policybindings/{binding_name}][%d] getPolicyBindingForbidden", 403)
}
...
func (o *GetPolicyBindingDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/policybindings/{binding_name}][%d] getPolicyBinding default %s", o._statusCode, payload)
}
