...
func (o *CreatePolicyTemplateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CreatePolicyTemplateOK) Error() string {
	...
	return fmt.Sprintf("[POST /api/v2/policytemplates][%d] createPolicyTemplateOK %s", 200, payload)
}
...
func (o *CreatePolicyTemplateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /api/v2/policytemplates][%d] createPolicyTemplate default %s", o._statusCode, payload)
}
