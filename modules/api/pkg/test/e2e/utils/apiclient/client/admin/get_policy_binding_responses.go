...
func (o *GetPolicyBindingOK) Error() string {
	return fmt.Sprintf("[GET /api/v2/policybindings/{binding_name}/{namespace}][%d] getPolicyBindingOK  %+v", 200, o.Payload)
}
...
func (o *GetPolicyBindingUnauthorized) Error() string {
	return fmt.Sprintf("[GET /api/v2/policybindings/{binding_name}/{namespace}][%d] getPolicyBindingUnauthorized ", 401)
}
...
func (o *GetPolicyBindingForbidden) Error() string {
	return fmt.Sprintf("[GET /api/v2/policybindings/{binding_name}/{namespace}][%d] getPolicyBindingForbidden ", 403)
}
...
func (o *GetPolicyBindingDefault) Error() string {
	return fmt.Sprintf("[GET /api/v2/policybindings/{binding_name}/{namespace}][%d] getPolicyBinding default  %+v", o._statusCode, o.Payload)
}
