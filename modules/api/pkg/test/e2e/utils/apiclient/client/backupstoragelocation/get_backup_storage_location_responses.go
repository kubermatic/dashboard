...
func (o *GetBackupStorageLocationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the get backup storage location o k response
func (o *GetBackupStorageLocationOK) Code() int {
	return 200
}

func (o *GetBackupStorageLocationOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/backupstoragelocation/{bsl_name}][%d] getBackupStorageLocationOK %s", 200, payload)
}
...
// Code gets the status code for the get backup storage location unauthorized response
func (o *GetBackupStorageLocationUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the get backup storage location forbidden response
func (o *GetBackupStorageLocationForbidden) Code() int {
	return 403
}
...
func (o *GetBackupStorageLocationDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/backupstoragelocation/{bsl_name}][%d] getBackupStorageLocation default %s", o._statusCode, payload)
}
