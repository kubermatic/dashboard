...
func (o *PatchExternalClusterMachineDeploymentsParams) WithPatch(patch any) *PatchExternalClusterMachineDeploymentsParams {
	o.SetPatch(patch)
	return o
}

// SetPatch adds the patch to the patch external cluster machine deployments params
func (o *PatchExternalClusterMachineDeploymentsParams) SetPatch(patch any) {
	o.Patch = patch
}
