...
func (o *ListNodesForClusterReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the list nodes for cluster o k response
func (o *ListNodesForClusterOK) Code() int {
	return 200
}

func (o *ListNodesForClusterOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/nodes][%d] listNodesForClusterOK %s", 200, payload)
}
...
// Code gets the status code for the list nodes for cluster unauthorized response
func (o *ListNodesForClusterUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the list nodes for cluster forbidden response
func (o *ListNodesForClusterForbidden) Code() int {
	return 403
}
...
func (o *ListNodesForClusterDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/nodes][%d] listNodesForCluster default %s", o._statusCode, payload)
}
