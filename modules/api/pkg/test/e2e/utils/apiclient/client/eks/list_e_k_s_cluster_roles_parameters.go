...
// WithAssumeRoleARN adds the assumeRoleARN to the list e k s cluster roles params
func (o *ListEKSClusterRolesParams) WithAssumeRoleARN(assumeRoleARN *string) *ListEKSClusterRolesParams {
	o.SetAssumeRoleARN(assumeRoleARN)
	return o
}

// SetAssumeRoleARN adds the assumeRoleARN to the list e k s cluster roles params
func (o *ListEKSClusterRolesParams) SetAssumeRoleARN(assumeRoleARN *string) {
	o.AssumeRoleARN = assumeRoleARN
}

// WithAssumeRoleExternalID adds the assumeRoleExternalID to the list e k s cluster roles params
func (o *ListEKSClusterRolesParams) WithAssumeRoleExternalID(assumeRoleExternalID *string) *ListEKSClusterRolesParams {
	o.SetAssumeRoleExternalID(assumeRoleExternalID)
	return o
}

// SetAssumeRoleExternalID adds the assumeRoleExternalId to the list e k s cluster roles params
func (o *ListEKSClusterRolesParams) SetAssumeRoleExternalID(assumeRoleExternalID *string) {
