...
func (o *ListProjectOpenstackServerGroupsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the list project openstack server groups o k response
func (o *ListProjectOpenstackServerGroupsOK) Code() int {
	return 200
}

func (o *ListProjectOpenstackServerGroupsOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/providers/openstack/servergroups][%d] listProjectOpenstackServerGroupsOK %s", 200, payload)
}
...
func (o *ListProjectOpenstackServerGroupsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/providers/openstack/servergroups][%d] listProjectOpenstackServerGroups default %s", o._statusCode, payload)
}
