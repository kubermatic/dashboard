...
func (o *ListAzureSizesNoCredentialsV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the list azure sizes no credentials v2 o k response
func (o *ListAzureSizesNoCredentialsV2OK) Code() int {
	return 200
}

func (o *ListAzureSizesNoCredentialsV2OK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/azure/sizes][%d] listAzureSizesNoCredentialsV2OK %s", 200, payload)
}
...
func (o *ListAzureSizesNoCredentialsV2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/azure/sizes][%d] listAzureSizesNoCredentialsV2 default %s", o._statusCode, payload)
}
