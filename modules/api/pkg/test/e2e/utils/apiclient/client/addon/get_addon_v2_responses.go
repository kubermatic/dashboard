...
func (o *GetAddonV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the get addon v2 o k response
func (o *GetAddonV2OK) Code() int {
	return 200
}

func (o *GetAddonV2OK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/addons/{addon_id}][%d] getAddonV2OK %s", 200, payload)
}
...
// Code gets the status code for the get addon v2 unauthorized response
func (o *GetAddonV2Unauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the get addon v2 forbidden response
func (o *GetAddonV2Forbidden) Code() int {
	return 403
}
...
func (o *GetAddonV2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/addons/{addon_id}][%d] getAddonV2 default %s", o._statusCode, payload)
}
