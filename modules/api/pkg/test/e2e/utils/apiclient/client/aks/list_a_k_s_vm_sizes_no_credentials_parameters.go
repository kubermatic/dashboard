...
// NewListAKSVMSizesNoCredentialsParams creates a new ListAKSVMSizesNoCredentialsParams object,
...
func NewListAKSVMSizesNoCredentialsParams() *ListAKSVMSizesNoCredentialsParams {
	return &ListAKSVMSizesNoCredentialsParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewListAKSVMSizesNoCredentialsParamsWithTimeout creates a new ListAKSVMSizesNoCredentialsParams object
...
// NewListAKSVMSizesNoCredentialsParamsWithContext creates a new ListAKSVMSizesNoCredentialsParams object
...
// NewListAKSVMSizesNoCredentialsParamsWithHTTPClient creates a new ListAKSVMSizesNoCredentialsParams object
...
func (o *ListAKSVMSizesNoCredentialsParams) WithDefaults() *ListAKSVMSizesNoCredentialsParams {
	o.SetDefaults()
	return o
}
...
func (o *ListAKSVMSizesNoCredentialsParams) WithTimeout(timeout time.Duration) *ListAKSVMSizesNoCredentialsParams {
...
func (o *ListAKSVMSizesNoCredentialsParams) WithContext(ctx context.Context) *ListAKSVMSizesNoCredentialsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the list a k s VM sizes no credentials params
func (o *ListAKSVMSizesNoCredentialsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the list a k s VM sizes no credentials params
func (o *ListAKSVMSizesNoCredentialsParams) WithHTTPClient(client *http.Client) *ListAKSVMSizesNoCredentialsParams {
...
func (o *ListAKSVMSizesNoCredentialsParams) WithLocation(location *string) *ListAKSVMSizesNoCredentialsParams {
...
func (o *ListAKSVMSizesNoCredentialsParams) WithClusterID(clusterID string) *ListAKSVMSizesNoCredentialsParams {
...
func (o *ListAKSVMSizesNoCredentialsParams) WithProjectID(projectID string) *ListAKSVMSizesNoCredentialsParams {
...
func (o *ListAKSVMSizesNoCredentialsParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
