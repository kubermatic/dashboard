...
// Code gets the status code for the list packet sizes no credentials v2 o k response
func (o *ListPacketSizesNoCredentialsV2OK) Code() int {
	return 200
}

func (o *ListPacketSizesNoCredentialsV2OK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/packet/sizes][%d] listPacketSizesNoCredentialsV2OK %s", 200, payload)
}
...
func (o *ListPacketSizesNoCredentialsV2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/packet/sizes][%d] listPacketSizesNoCredentialsV2 default %s", o._statusCode, payload)
}
