...
func (o *GetClusterBackupStorageLocationOK) Error() string {
	...
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusterbackupstoragelocation/{cbs_name}][%d] getClusterBackupStorageLocationOK %s", 200, payload)
}
...
func (o *GetClusterBackupStorageLocationDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusterbackupstoragelocation/{cbs_name}][%d] getClusterBackupStorageLocation default %s", o._statusCode, payload)
}
