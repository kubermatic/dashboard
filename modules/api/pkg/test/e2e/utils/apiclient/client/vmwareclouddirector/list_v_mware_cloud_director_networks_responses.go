...
func (o *ListVMwareCloudDirectorNetworksReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the list v mware cloud director networks o k response
func (o *ListVMwareCloudDirectorNetworksOK) Code() int {
	return 200
}

func (o *ListVMwareCloudDirectorNetworksOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/providers/vmwareclouddirector/{dc}/networks][%d] listVMwareCloudDirectorNetworksOK %s", 200, payload)
}
...
func (o *ListVMwareCloudDirectorNetworksDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/providers/vmwareclouddirector/{dc}/networks][%d] listVMwareCloudDirectorNetworks default %s", o._statusCode, payload)
}
