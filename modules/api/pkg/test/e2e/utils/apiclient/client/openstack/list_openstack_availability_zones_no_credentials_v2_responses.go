...
func (o *ListOpenstackAvailabilityZonesNoCredentialsV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the list openstack availability zones no credentials v2 o k response
func (o *ListOpenstackAvailabilityZonesNoCredentialsV2OK) Code() int {
	return 200
}

func (o *ListOpenstackAvailabilityZonesNoCredentialsV2OK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/openstack/availabilityzones][%d] listOpenstackAvailabilityZonesNoCredentialsV2OK %s", 200, payload)
}
...
func (o *ListOpenstackAvailabilityZonesNoCredentialsV2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/openstack/availabilityzones][%d] listOpenstackAvailabilityZonesNoCredentialsV2 default %s", o._statusCode, payload)
}
