...
func (o *ListExternalClusterMachineDeploymentNodesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the list external cluster machine deployment nodes o k response
func (o *ListExternalClusterMachineDeploymentNodesOK) Code() int {
	return 200
}

func (o *ListExternalClusterMachineDeploymentNodesOK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/kubernetes/clusters/{cluster_id}/machinedeployments/{machinedeployment_id}/nodes][%d] listExternalClusterMachineDeploymentNodesOK %s", 200, payload)
}
...
// Code gets the status code for the list external cluster machine deployment nodes unauthorized response
func (o *ListExternalClusterMachineDeploymentNodesUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the list external cluster machine deployment nodes forbidden response
func (o *ListExternalClusterMachineDeploymentNodesForbidden) Code() int {
	return 403
}
...
func (o *ListExternalClusterMachineDeploymentNodesDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/kubernetes/clusters/{cluster_id}/machinedeployments/{machinedeployment_id}/nodes][%d] listExternalClusterMachineDeploymentNodes default %s", o._statusCode, payload)
}
