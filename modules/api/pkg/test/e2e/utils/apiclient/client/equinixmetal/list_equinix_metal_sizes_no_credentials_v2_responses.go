...
func (o *ListEquinixMetalSizesNoCredentialsV2OK) Error() string {
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/equinixmetal/sizes][%d] listEquinixMetalSizesNoCredentialsV2OK  %+v", 200, o.Payload)
}
...
func (o *ListEquinixMetalSizesNoCredentialsV2Default) Error() string {
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/equinixmetal/sizes][%d] listEquinixMetalSizesNoCredentialsV2 default  %+v", o._statusCode, o.Payload)
}
