...
func (o *PatchpolicyTemplateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PatchpolicyTemplateOK) Error() string {
	...
	return fmt.Sprintf("[PATCH /api/v2/policytemplates/{template_name}][%d] patchpolicyTemplateOK %s", 200, payload)
}
...
func (o *PatchpolicyTemplateDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /api/v2/policytemplates/{template_name}][%d] patchpolicyTemplate default %s", o._statusCode, payload)
}
