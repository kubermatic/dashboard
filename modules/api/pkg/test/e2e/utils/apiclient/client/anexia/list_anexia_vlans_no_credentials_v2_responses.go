...
func (o *ListAnexiaVlansNoCredentialsV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
// Code gets the status code for the list anexia vlans no credentials v2 o k response
func (o *ListAnexiaVlansNoCredentialsV2OK) Code() int {
	return 200
}

func (o *ListAnexiaVlansNoCredentialsV2OK) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/anexia/vlans][%d] listAnexiaVlansNoCredentialsV2OK %s", 200, payload)
}
...
func (o *ListAnexiaVlansNoCredentialsV2Default) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /api/v2/projects/{project_id}/clusters/{cluster_id}/providers/anexia/vlans][%d] listAnexiaVlansNoCredentialsV2 default %s", o._statusCode, payload)
}
