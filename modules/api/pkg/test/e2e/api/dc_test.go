...
func TestListDCForSeed(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			seed:            "kubermatic",
			expectedDCNames: []string{"alibaba-eu-central-1a", "aws-eu-central-1a", "azure-westeurope", "byo-kubernetes", "do-ams3", "do-fra1", "gcp-westeurope", "hetzner-hel1", "hetzner-nbg1", "kubevirt-europe-west3-c", "syseleven-dbl1", "vsphere-ger"},
		},
	}
