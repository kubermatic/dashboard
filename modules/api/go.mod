...
require (
	...
	github.com/open-policy-agent/frameworks/constraint v0.0.0-20230201235642-777dc99a6669 // v0.5.1
...
replace (
	...
	k8c.io/kubermatic/v2 => k8c.io/kubermatic/v2 v2.22.1-0.20230227150750-1a438700f398
)
