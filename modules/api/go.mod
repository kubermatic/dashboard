...
replace (
	k8c.io/kubeone => k8c.io/kubeone v1.5.0-beta.0.0.20230215100128-c9a3d7aa7176
	k8c.io/kubermatic/v2 => k8c.io/kubermatic/v2 v2.22.0-alpha.0.0.20230208172731-c146e14d49f3
)
