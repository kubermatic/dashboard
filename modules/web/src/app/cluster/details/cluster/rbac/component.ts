  ...
  deleteServiceAccount(element: ClusterServiceAccount): void {
    const dialogConfig: MatDialogConfig = {
      data: {
        ...
        message: `Delete service account <b>${_.escape(element.name)}</b> of <b>${_.escape(
          this.cluster.name
  ...
  deleteBinding(element: SimpleClusterBinding): void {
    const dialogConfig: MatDialogConfig = {
      data: {
        ...
        message: `Delete binding for ${element.kind.toLowerCase()} <b>${_.escape(element.name)}</b> of <b>${_.escape(
          this.cluster.name
        )}</b> cluster permanently?`,
        confirmLabel: 'Delete',
      },
