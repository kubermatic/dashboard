...
export class NameGeneratorService {
  ...
  private suffix: string[] = [
    ...
    she became the first female recipient of the ACM's Turing Award. https://en.wikipedia.org/wiki/Frances_E._Allen */
    'allen',
  ...
  */
    ...
    analysis. https://en.wikipedia.org/wiki/Stefan_Banach */
    'banach',

    // John Bardeen co-invented the transistor - https://en.wikipedia.org/wiki/John_Bardeen
    'bardeen',

    /* Jean Bartik, born Betty Jean Jennings, was one of the original programmers for the
    ENIAC computer. https://en.wikipedia.org/wiki/Jean_Bartik */
    'bartik',
    ...
    of physics at the Tata Institute of Fundamental Research. Colloquially known as
    "father of Indian nuclear programme"- https://en.wikipedia.org/wiki/Homi_J._Bhabha */
    'bhabha',
    ...
    degree - https://en.wikipedia.org/wiki/Elizabeth_Blackwell */
    'blackwell',
    ...
    Technology (IWT). https://en.wikipedia.org/wiki/Anita_Borg */
    'borg',

    /* Satyendra Nath Bose - He provided the foundation for Bose–Einstein statistics and
    the theory of the Bose–Einstein condensate. - https://en.wikipedia.org/wiki/Satyendra_Nath_Bose */
    'bose',
    ...
    /* Brahmagupta - Ancient Indian mathematician during 598-670 CE who gave rules to
    compute with zero - https://en.wikipedia.org/wiki/Brahmagupta#Zero */
    'brahmagupta',
    ...
    /* Rachel Carson - American marine biologist and conservationist, her book Silent
    Spring and other writings are credited with advancing the global environmental
    movement. https://en.wikipedia.org/wiki/Rachel_Carson */
    'carson',

    /* Subrahmanyan Chandrasekhar - Astrophysicist known for his mathematical theory on
    different stages and evolution in structures of the stars. He has won nobel prize
    for physics - https://en.wikipedia.org/wiki/Subrahmanyan_Chandrasekhar */
    'chandrasekhar',

    // Claude Shannon - The father of information theory and founder of digital circuit
    // design theory. (https://en.wikipedia.org/wiki/Claude_Shannon)
    'shannon',

    // Joan Clarke - Bletchley Park code breaker during the Second World War who
    // pioneered techniques that remained top secret for decades. Also an accomplished
    ...
    // Joan Curran was a Welsh scientist who developed radar and invented chaff, a radar
    // countermeasure. https://en.wikipedia.org/wiki/Joan_Curran
    // Samuel Curran was an Irish physicist who worked alongside his wife during
    // WWII and invented the proximity fuse. https://en.wikipedia.org/wiki/Samuel_Curran
    'curran',
    ...
    // obscurantism to establish scientific truth.  https://en.wikipedia.org/wiki/Galileo_Galilei
    'galileo',

    // William Henry "Bill" Gates III is an American business magnate, philanthropist,
    // investor, computer programmer, and inventor. https://en.wikipedia.org/wiki/Bill_Gates
    'gates',
    ...
    // for the first electronic digital computer, ENIAC. https://en.wikipedia.org/wiki/Adele_Goldstine
    'goldstine',
    ...
    // Stephen Hawking pioneered the field of cosmology by combining general relativity
    // and quantum mechanics. https://en.wikipedia.org/wiki/Stephen_Hawking
    'hawking',
    ...
    // electroanalytical method, and recipient of the Nobel Prize in 1959. His main
    // field of work was polarography. https://en.wikipedia.org/wiki/Jaroslav_Heyrovsk%C3%BD
    'heyrovsky',
    ...
    // telephone switching method. https://en.wikipedia.org/wiki/Erna_Schneider_Hoover
    'hoover',
    ...
    // to the understanding of semiconductors, integrated circuitry, and the unique electrical
    // principles of microscopic materials. https://en.wikipedia.org/wiki/Frances_Hugle
    'hugle',

    // Hypatia - Greek Alexandrine Neoplatonist philosopher in Egypt who was one of the
    // earliest mothers of mathematics - https://en.wikipedia.org/wiki/Hypatia
    'hypatia',
    ...
    // Mary Lou Jepsen, was the founder and chief technology officer of One Laptop Per Child (OLPC),
    // and the founder of Pixel Qi. https://en.wikipedia.org/wiki/Mary_Lou_Jepsen
    'jepsen',
    ...
    // in most search engines today. https://en.wikipedia.org/wiki/Karen_Sp%C3%A4rck_Jones
    'jones',
    ...
    // Macintosh in the 1980s, and was an original employee of NeXT, working as the Creative Director.
    // https://en.wikipedia.org/wiki/Susan_Kare
    'kare',

    // Mary Kenneth Keller, Sister Mary Kenneth Keller became the first American woman to
    // earn a PhD in Computer Science in 1965. https://en.wikipedia.org/wiki/Mary_Kenneth_Keller
    'keller',
    ...
    // Sophie Kowalevski - Russian mathematician responsible for important original contributions to
    // analysis, differential equations and mechanics - https://en.wikipedia.org/wiki/Sofia_Kovalevskaya
    'kowalevski',
    ...
    // incorporated into modern Wi-Fi, CDMA and Bluetooth technology. https://en.wikipedia.org/wiki/Hedy_Lamarr
    'lamarr',
    ...
    // optimization techniques for routing traffic on the internet. Died attempting to
    // stop the 9-11 hijackers. https://en.wikipedia.org/wiki/Daniel_Lewin
    'lewin',
    ...
    // winner of the Turing Prize in 2008. - https://en.wikipedia.org/wiki/Barbara_Liskov
    'liskov',
    ...
    // algebraic identities - https://en.wikipedia.org/wiki/Mah%C4%81v%C4%ABra_(mathematician)
    'mahavira',

    // Maria Mayer - American theoretical physicist and Nobel laureate in Physics for
    // proposing the nuclear shell model of the atomic nucleus - https://en.wikipedia.org/wiki/Maria_Mayer
    'mayer',
    ...
    // Physiology or Medicine for discovering transposons. https://en.wikipedia.org/wiki/Barbara_McClintock
    'mcclintock',
    ...
    // https://en.wikipedia.org/wiki/ENIAC - https://en.wikipedia.org/wiki/Kathleen_Antonelli
    'mcnulty',

    // Lise Meitner - Austrian/Swedish physicist who was involved in the discovery of
    // nuclear fission. The element meitnerium is named after her - https://en.wikipedia.org/wiki/Lise_Meitner
    'meitner',

    // Carla Meninsky, was the game designer and programmer for Atari 2600 games Dodge
    // 'Em and Warlords. https://en.wikipedia.org/wiki/Carla_Meninsky
    'meninsky',

    // Johanna Mestorf - German prehistoric archaeologist and first female museum director
    // in Germany - https://en.wikipedia.org/wiki/Johanna_Mestorf
    'mestorf',

    // Marvin Minsky - Pioneer in Artificial Intelligence, co-founder of the MIT's AI Lab,
    // won the Turing Award in 1969. https://en.wikipedia.org/wiki/Marvin_Minsky
    'minsky',
    ...
    // European telegraphs and was a co-developer of the Morse code - https://en.wikipedia.org/wiki/Samuel_Morse
    'morse',
    ...
    // Florence Nightingale, more prominently known as a nurse, was also the first female
    // member of the Royal Statistical Society and a pioneer in statistical graphics
    ...
    // Rob Pike was a key contributor to Unix, Plan 9, the X graphic system, utf-8, and the
    ...
    // crypto tools, advances the causes of truth and freedom of information by
    // reporting disclosures by whistleblowers such as Edward Snowden. https://en.wikipedia.org/wiki/Laura_Poitras
    'poitras',
    ...
    // Raman effect. - https://en.wikipedia.org/wiki/C._V._Raman
    'raman',
    ...
    // continued fractions. - https://en.wikipedia.org/wiki/Srinivasa_Ramanujan
    'ramanujan',

    // Sally Kristen Ride was an American physicist and astronaut. She was the first
    // American woman in space, and the youngest American astronaut. https://en.wikipedia.org/wiki/Sally_Ride
    'ride',
    ...
    // research was critical to the understanding of DNA - https://en.wikipedia.org/wiki/Rosalind_Franklin
    'rosalind',
    ...
    // symbolic manipulation of mathematical formulas. https://en.wikipedia.org/wiki/Jean_E._Sammet
    'sammet',

    // Carol Shaw - Originally an Atari employee, Carol Shaw is said to be the first
    // female video game designer. https://en.wikipedia.org/wiki/Carol_Shaw_(video_game_designer)
    'shaw',
    ...
    // cause of AIDS. https://en.wikipedia.org/wiki/Fran%C3%A7oise_Barr%C3%A9-Sinoussi
    'sinoussi',

    // Betty Snyder - one of the original programmers of the ENIAC.
    // https://en.wikipedia.org/wiki/ENIAC - https://en.wikipedia.org/wiki/Betty_Holberton
    'snyder',

    // Frances Spence - one of the original programmers of the ENIAC.
    // https://en.wikipedia.org/wiki/ENIAC - https://en.wikipedia.org/wiki/Frances_Spence
    'spence',

    // Richard Matthew Stallman - the founder of the Free Software movement, the GNU
    // project, the Free Software Foundation, and the League for Programming Freedom.
    // He also invented the concept of copyleft to protect the ideals of this movement,
    // and enshrined this concept in the widely-used GPL (General Public License)
    // for software. https://en.wikiquote.org/wiki/Richard_Stallman
    'stallman',

    // Michael Stonebraker is a database research pioneer and architect of Ingres,
    // Postgres, VoltDB and SciDB. Winner of 2014 ACM Turing Award. https://en.wikipedia.org/wiki/Michael_Stonebraker
    'stonebraker',
    ...
    // and much of the internet as we know it today. He was devoted to freedom of
    // information on the web. https://en.wikiquote.org/wiki/Aaron_Swartz
    'swartz',
    ...
    // formulae during 505-587 CE - https://en.wikipedia.org/wiki/Var%C4%81hamihira#Contributions
    'varahamihira',

    // Sir Mokshagundam Visvesvaraya - is a notable Indian engineer.  He is a recipient of
    // the Indian Republic's highest honour, the Bharat Ratna, in 1955. On his birthday,
    // 15 September is celebrated as Engineer's Day in India in his memory - https://en.wikipedia.org/wiki/Visvesvaraya
    'visvesvaraya',

    // Christiane Nüsslein-Volhard - German biologist, won Nobel Prize in Physiology or
    // Medicine in 1995 for research on the genetic control of embryonic development.
    ...
    // Andrew Wiles - Notable British mathematician who proved the enigmatic Fermat's
    // Last Theorem - https://en.wikipedia.org/wiki/Andrew_Wiles
    'wiles',

    // Roberta Williams, did pioneering work in graphical adventure games for personal
    // computers, particularly the King's Quest series. https://en.wikipedia.org/wiki/Roberta_Williams
    'williams',

    // Sophie Wilson designed the first Acorn Micro-Computer and the instruction
    // set for ARM processors. https://en.wikipedia.org/wiki/Sophie_Wilson
    'wilson',
    ...
    // controlled, powered and sustained heavier-than-air human flight - https://en.wikipedia.org/wiki/Wright_brothers
    'wright',

    // Rosalyn Sussman Yalow - Rosalyn Sussman Yalow was an American medical physicist,
    // and a co-winner of the 1977 Nobel Prize in Physiology or Medicine for development
    // of the radioimmunoassay technique. https://en.wikipedia.org/wiki/Rosalyn_Sussman_Yalow
    'yalow',
  ...
  generateName(): string {
    return (
      this.prefix[this.randomNumberInsideInterval(0, this.prefix.length)] +
      '-' +
