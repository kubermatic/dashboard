  ...
  showMachineDeploymentDeleteDialog(
    ...
    const dialogConfig: MatDialogConfig = {
      data: {
        ...
        message: `Delete <b>${_.escape(md.name)}</b> machine deployment of <b>${_.escape(
          cluster.name
  ...
  showMachineDeploymentRestartDialog(
    ...
    const dialogConfig: MatDialogConfig = {
      data: {
        ...
        message: `Perform rolling restart of <b>${_.escape(md.name)}</b> machine deployment of <b>${_.escape(
          cluster.name
        )}</b> cluster?`,
