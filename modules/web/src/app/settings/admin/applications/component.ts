...
import {ApplicationDefinition, isSystemApplication} from '@app/shared/entity/application';
...
export class ApplicationsComponent implements OnInit, OnChanges {
  ...
  ngOnInit() {
    this.dataSource.data = this.applications?.filter(app => !isSystemApplication(app.labels));
