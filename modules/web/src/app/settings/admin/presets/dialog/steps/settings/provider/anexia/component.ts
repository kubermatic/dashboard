...
import {AnexiaPresetSpec} from '@shared/entity/preset';
...
@Component({
  selector: 'km-anexia-settings',
  templateUrl: './template.html',
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => AnexiaSettingsComponent),
      multi: true,
    },
    {
...
export class AnexiaSettingsComponent extends BaseFormValidator implements OnInit, OnDestroy {
  ...
  ngOnDestroy(): void {
    ...
    delete this._presetDialogService.preset.spec.anexia;
  }

  private _update(): void {
    this._presetDialogService.preset.spec.anexia = {
