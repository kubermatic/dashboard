...
import {BaremetalPresetSpec, BaremetalTinkerbellPresetSpec} from '@shared/entity/preset';
...
export class BaremetalSettingsComponent extends BaseFormValidator implements OnInit, OnDestroy {
  ...
  ngOnDestroy(): void {
    ...
    delete this._presetDialogService.preset.spec.baremetal;
  }

  private _update(): void {
    this._presetDialogService.preset.spec.baremetal = {
      tinkerbell: {
        kubeconfig: this.form.get(Controls.Kubeconfig).value,
      } as BaremetalTinkerbellPresetSpec,
    } as BaremetalPresetSpec;
  }
}
