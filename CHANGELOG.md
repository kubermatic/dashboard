...
- Service Accounts have been added to the UI [#1158](https://github.com/kubermatic/dashboard/issues/1158) ([kgroschoff](https://github.com/kgroschoff))
...
- Serviceaccount tokens can now be downloaded. [#1234](https://github.com/kubermatic/dashboard/issues/1234) ([kgroschoff](https://github.com/kgroschoff))
...
- Add OpenShift support in UI [#1274](https://github.com/kubermatic/dashboard/issues/1274) ([kgroschoff](https://github.com/kgroschoff))
...
- Nodes and Node Deployments statuses are more accurate [#1016](https://github.com/kubermatic/dashboard/issues/1016) ([maciaszczykm](https://github.com/maciaszczykm))
- DigitalOcean sizes and OpenStack flavors option pickers have been redesigned. [#1021](https://github.com/kubermatic/dashboard/issues/1021) ([maciaszczykm](https://github.com/maciaszczykm))
- Smoother operation on bad network connection thanks to changes in asset caching. [#1030](https://github.com/kubermatic/dashboard/issues/1030) ([kdomanski](https://github.com/kdomanski))
- Added a flag allowing to change the default number of nodes created with clusters. [#1032](https://github.com/kubermatic/dashboard/issues/1032) ([maciaszczykm](https://github.com/maciaszczykm))
- Setting openstack tags for instances is possible via UI now. [#1038](https://github.com/kubermatic/dashboard/issues/1038) ([kgroschoff](https://github.com/kgroschoff))
- Node Deployments can now be named. [#1039](https://github.com/kubermatic/dashboard/issues/1039) ([maciaszczykm](https://github.com/maciaszczykm))
- Adding multiple owners to a project is possible via UI now. [#1042](https://github.com/kubermatic/dashboard/issues/1042) ([kgroschoff](https://github.com/kgroschoff))
- kubelet version can now be specified for Node Deployments. [#1047](https://github.com/kubermatic/dashboard/issues/1047) ([maciaszczykm](https://github.com/maciaszczykm))
- Events related to the Nodes are now displayed in the Node Deployment details view. [#1054](https://github.com/kubermatic/dashboard/issues/1054) ([maciaszczykm](https://github.com/maciaszczykm))
- Fixed reload behaviour of openstack setting fields. [#1056](https://github.com/kubermatic/dashboard/issues/1056) ([kgroschoff](https://github.com/kgroschoff))
- Fixed missing dashboard version info in the footer. [#1067](https://github.com/kubermatic/dashboard/issues/1067) ([maciaszczykm](https://github.com/maciaszczykm))
- Project owners visible in project list view now. [#1082](https://github.com/kubermatic/dashboard/issues/1082) ([kgroschoff](https://github.com/kgroschoff))
- Added possibility to assign labels to nodes. [#1101](https://github.com/kubermatic/dashboard/issues/1101) ([maciaszczykm](https://github.com/maciaszczykm))
- User will be warned about cluster upgrades unavailable due to old nodes. [#1121](https://github.com/kubermatic/dashboard/issues/1121) ([maciaszczykm](https://github.com/maciaszczykm))
- Updated list of AWS instance types to match latest available. [#1122](https://github.com/kubermatic/dashboard/issues/1122) ([maciaszczykm](https://github.com/maciaszczykm))
- Fixed display number of replicas if the field is empty (0 replicas). [#1126](https://github.com/kubermatic/dashboard/issues/1126) ([maciaszczykm](https://github.com/maciaszczykm))
- Added an option to include custom links into the application. [#1131](https://github.com/kubermatic/dashboard/issues/1131) ([maciaszczykm](https://github.com/maciaszczykm))
- Minor layout issues with the cluster wizard have been fixed. [#1134](https://github.com/kubermatic/dashboard/issues/1134) ([kgroschoff](https://github.com/kgroschoff))
- Removed AWS instance types t3.nano &amp; t3.micro as they are too small to schedule any workload on them [#1138](https://github.com/kubermatic/dashboard/issues/1138) ([mrIncompetent](https://github.com/mrIncompetent))
- Application sidebar has been redesigned. [#1173](https://github.com/kubermatic/dashboard/issues/1173) ([maciaszczykm](https://github.com/maciaszczykm))
...
- Removed AWS instance types t3.nano &amp; t3.micro as they are too small to schedule any workload on them [#1140](https://github.com/kubermatic/dashboard/issues/1140) ([kubermatic-bot](https://github.com/kubermatic-bot))
...
- Updated list of AWS instance types to match latest available. [#1127](https://github.com/kubermatic/dashboard/issues/1127) ([kubermatic-bot](https://github.com/kubermatic-bot))
...
- Fixed missing dashboard version info in the footer. [#1096](https://github.com/kubermatic/dashboard/issues/1096) ([kubermatic-bot](https://github.com/kubermatic-bot))
...
- Added support for creating, viewing, updating and deleting node deployments. [#949](https://github.com/kubermatic/dashboard/issues/949) ([maciaszczykm](https://github.com/maciaszczykm))
- Added Node Deployment details view [#973](https://github.com/kubermatic/dashboard/issues/973) ([maciaszczykm](https://github.com/maciaszczykm))
...
- Fixed a bug that caused the credentials to be tested against the API before the user is done typing them [#661](https://github.com/kubermatic/dashboard/issues/661) ([kgroschoff](https://github.com/kgroschoff))


**Cloud Provider:**

- Added Azure support [#658](https://github.com/kubermatic/dashboard/issues/658) ([kgroschoff](https://github.com/kgroschoff))


**Misc:**

- You can now choose a specific Kubernetes version for newly created clusters [#643](https://github.com/kubermatic/dashboard/issues/643) ([kgroschoff](https://github.com/kgroschoff))
- Kubeconfig can now be downloaded even for paused clusters [#645](https://github.com/kubermatic/dashboard/issues/645) ([kgroschoff](https://github.com/kgroschoff))
- Support button has been removed [#649](https://github.com/kubermatic/dashboard/issues/649) ([kgroschoff](https://github.com/kgroschoff))
- Added CentOS support [#659](https://github.com/kubermatic/dashboard/issues/659) ([kgroschoff](https://github.com/kgroschoff))
- Credentials fields are now password fields [#660](https://github.com/kubermatic/dashboard/issues/660) ([kgroschoff](https://github.com/kgroschoff))
- Various minor fixes and improvements
...
- New Kubernetes versions will only be advertised for upgrade if they are a higher version [#639](https://github.com/kubermatic/dashboard/issues/639) ([kgroschoff](https://github.com/kgroschoff))


**Cloud Provider:**

- Provider settings can now be edited in existing clusters [#638](https://github.com/kubermatic/dashboard/issues/638) ([kgroschoff](https://github.com/kgroschoff))
...
- Fixed the display of very long cluster names [#592](https://github.com/kubermatic/dashboard/issues/592) ([kgroschoff](https://github.com/kgroschoff))
- Removed duplicate info from AWS cluster creation summary [#593](https://github.com/kubermatic/dashboard/issues/593) ([j3ank](https://github.com/j3ank))
- Fixed downloading kubeconfig in Firefox [#596](https://github.com/kubermatic/dashboard/issues/596) ([kgroschoff](https://github.com/kgroschoff))
- Fixed node accordion opening up when deleting a node [#619](https://github.com/kubermatic/dashboard/issues/619) ([kgroschoff](https://github.com/kgroschoff))


**Cloud Provider:**

- Disabled CoreOS on Openstack [#630](https://github.com/kubermatic/dashboard/issues/630) ([kgroschoff](https://github.com/kgroschoff))


**Misc:**

- Node count will now default to 3 or 1 depending on whether the user is creating a new cluster or just adding nodes [#582](https://github.com/kubermatic/dashboard/issues/582) ([kgroschoff](https://github.com/kgroschoff))
- Operating system logo will now be displayed on the node list [#586](https://github.com/kubermatic/dashboard/issues/586) ([kgroschoff](https://github.com/kgroschoff))
  - Docker will be selected by default [#608](https://github.com/kubermatic/dashboard/issues/608) ([kgroschoff](https://github.com/kgroschoff))
- Improved hint for SSH login name [#587](https://github.com/kubermatic/dashboard/issues/587) ([kgroschoff](https://github.com/kgroschoff))
- Downloaded kubeconfig will now contain the cluster&#39;s ID in its file name [#600](https://github.com/kubermatic/dashboard/issues/600) ([kgroschoff](https://github.com/kgroschoff))
- Paused clusters will now display the reason for pause [#602](https://github.com/kubermatic/dashboard/issues/602) ([kgroschoff](https://github.com/kgroschoff))
- Optional fields of cluster configuration are now hidden in the simple view [#613](https://github.com/kubermatic/dashboard/issues/613) ([kgroschoff](https://github.com/kgroschoff))
- Added a copy tooltip when hovering over an admin token [#629](https://github.com/kubermatic/dashboard/issues/629) ([kgroschoff](https://github.com/kgroschoff))
- Node list has been redesigned [#633](https://github.com/kubermatic/dashboard/issues/633) ([kgroschoff](https://github.com/kgroschoff))
  - Node list now shows nodes&#39; creation dates [#606](https://github.com/kubermatic/dashboard/issues/606) ([kgroschoff](https://github.com/kgroschoff))
  - Node creation now allows to choose an OS and container runtime [#597](https://github.com/kubermatic/dashboard/issues/597) ([kgroschoff](https://github.com/kgroschoff))
- Various minor fixes and improvements
