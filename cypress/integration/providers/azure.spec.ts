...
import {Azure, Provider} from '../../utils/provider';
import {View} from '../../utils/view';
import {WizardStep} from '../../utils/wizard';

describe('Azure Provider', () => {
  const preset = Mocks.enabled() ? Preset.Mock : Preset.Azure;
  ...
  it('should create a new cluster', () => {
    ...
    WizardPage.getDatacenterBtn(Azure.WestEurope).click();
