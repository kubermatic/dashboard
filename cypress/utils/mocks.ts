...
export class Mocks {
  ...
  private static _defaults: Mock[] = [
    ...
    {m: RequestType.POST, p: Endpoint.ServiceAccounts, r: {fixture: 'services-account.json'}},
    {m: RequestType.GET, p: Endpoint.ServiceAccount, r: {fixture: 'services-account.json'}},
    {m: RequestType.GET, p: Endpoint.ServiceAccounts, r: {fixture: 'services-accounts.json'}},
